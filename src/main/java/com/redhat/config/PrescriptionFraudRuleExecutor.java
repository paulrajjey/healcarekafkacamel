...
public class PrescriptionFraudRuleExecutor{
	...
	public void executeCEPRule() {
		 ...
		 ReleaseId rId = ks.newReleaseId("com.fraud", "fraudalert", "1.0.0");
	...
	public Prescription executeRule(Prescription event){
	...
	public static void main(String[] arg){
		PrescriptionFraudRuleExecutor exec = new PrescriptionFraudRuleExecutor();
		//exec.executeRule();
		//exec.deserialize();
		exec.executeCEPRule();
